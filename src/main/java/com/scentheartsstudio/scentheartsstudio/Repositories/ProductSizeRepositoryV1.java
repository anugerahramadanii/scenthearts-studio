...
//
//@Repository
//public interface ProductSizeRepositoryV1 extends JpaRepository<ProductSizeEntity, Long> {
//
//	@Modifying
//	@Transactional
...
//
//	@Query(nativeQuery = true,
//			value = "select exists(select * from t_product_size where size ilike :size and is_delete = false)")
//	public Boolean isExistSize(@Param("size") String size);
//
//	@Query(nativeQuery = true,
